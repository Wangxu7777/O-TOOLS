...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="neirong3">
          <p style="float: left;">{{ item.customername }}</p>
          <p style="float: right;">{{ item.customerfinalname }}</p>
        </div>
      </van-cell>
    </van-list>
    <div class="btn">
...
export default {
  ...
  methods: {
    news() {
      this.$router.push({ path: "/chanceDetailsManagement" });
    },
    see(id) {
